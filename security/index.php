...
requireSetup();
requireLogin();
$pageTitle = 'Security — cPanel Manager';
$activePage = 'security';
...
<div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
  <div>
    ...
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">UAPI: Security status</p>
  </div>
...
<div class="rounded-xl border border-dashed border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-16 text-center shadow-sm">
  <div class="flex h-14 w-14 items-center justify-center rounded-xl bg-blue-50 dark:bg-blue-900/20 mx-auto mb-4">
    <i data-lucide="shield" class="h-7 w-7 text-blue-600 dark:text-blue-400"></i>
  </div>
  <h2 class="text-base font-semibold text-gray-900 dark:text-white mb-2">Security</h2>
  ...
  <div class="inline-flex items-center gap-2 rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 px-4 py-2">
    ...
    <span class="text-xs font-mono text-gray-500 dark:text-gray-400">Security status</span>
  </div>
</div>
<?php
require_once '../includes/auth.php';
